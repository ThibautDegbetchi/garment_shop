  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.title,
          style: TextStyle(color: tdBlackColor),
        ),
        centerTitle: true,
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: RichText(
                              text: const TextSpan(
                                  text:
                                      "Smart phone\ntrès maniable, facile d'utilisation",
                                  style:
                ...
                StaggeredGridView.countBuilder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return InkWell(
                      onTap: () {
                        print(
                          '${produces[index].name} ${produces[index].price}${produces[index].url}${produces[index].isFavorite}',
                        );
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ProductPage(
                                      produce: produces[index],
                                    )));
                      },
                      child: buildImageCard(index, produces[index].url[0],
                          produces[index].name, produces[index].price),
                    );
                  },
